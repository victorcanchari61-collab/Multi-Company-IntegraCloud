...
public sealed class Product : AggregateRoot
{
    ...
    public string? TechnicalSheetUrl { get; private set; }
    ...
    /// <summary>Imagen y ficha técnica (data-URL). Separado del constructor para no engordarlo.</summary>
    public void SetMedia(string? imageUrl, string? technicalSheetUrl)
    {
        ImageUrl = imageUrl;
