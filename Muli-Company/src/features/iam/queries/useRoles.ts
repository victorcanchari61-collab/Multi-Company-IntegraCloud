...
export const roleKeys = {
  ...
  tree: (companyId: string) => ['roles', companyId, 'tree'] as const,
}
...
export const useRoleTree = (companyId: string) =>
  useQuery({
    queryKey: roleKeys.tree(companyId),
    queryFn: () => getRoleTree(companyId),
    enabled: Boolean(companyId),
  })
