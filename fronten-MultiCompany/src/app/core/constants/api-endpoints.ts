...
export const API_ENDPOINTS = {
  ...
  erpProductPresentations: (productId: string) => `/erp/products/${productId}/presentations`,
  erpProductPresentation: (productId: string, id: string) => `/erp/products/${productId}/presentations/${id}`,
  erpProductPrices: (productId: string) => `/erp/products/${productId}/prices`,
